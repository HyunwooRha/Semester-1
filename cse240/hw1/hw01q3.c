// Your first name and last name here
...
int main(){
	...
	// Problem 2: (4 points)
	// You want that half of 50 tobe 25, why is the program printing that half of 50 is 0? Correct the error(s) (2 points).
   ...
   printf("y is %i\n",y);
	...
	printf("Error Type: Semantic \n\n");
     ...
     printf("The error should be Semantic because we tried to pass a character value instead of an integer value \n\n");
